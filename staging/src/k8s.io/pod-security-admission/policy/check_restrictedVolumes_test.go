...
func TestRestrictedVolumes(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			expectDetail: `volumes ` +
				...
				`"hostPath", "iscsi", "nfs", "photonPersistentDisk", "portworxVolume", "quobyte", "rbd", "scaleIO", "storageos", "unknown", "vsphereVolume"`,
			expectErrList: field.ErrorList{
				{Type: field.ErrorTypeForbidden, Field: "spec.volumes[8].hostPath", BadValue: []string{}},
				{Type: field.ErrorTypeForbidden, Field: "spec.volumes[9].gcePersistentDisk", BadValue: []string{}},
				{Type: field.ErrorTypeForbidden, Field: "spec.volumes[10].awsElasticBlockStore", BadValue: []string{}},
				{Type: field.ErrorTypeForbidden, Field: "spec.volumes[11].gitRepo", BadValue: []string{}},
				{Type: field.ErrorTypeForbidden, Field: "spec.volumes[12].nfs", BadValue: []string{}},
				{Type: field.ErrorTypeForbidden, Field: "spec.volumes[13].iscsi", BadValue: []string{}},
				{Type: field.ErrorTypeForbidden, Field: "spec.volumes[14].glusterfs", BadValue: []string{}},
				{Type: field.ErrorTypeForbidden, Field: "spec.volumes[15].rbd", BadValue: []string{}},
				{Type: field.ErrorTypeForbidden, Field: "spec.volumes[16].flexVolume", BadValue: []string{}},
				{Type: field.ErrorTypeForbidden, Field: "spec.volumes[17].cinder", BadValue: []string{}},
				{Type: field.ErrorTypeForbidden, Field: "spec.volumes[18].cephfs", BadValue: []string{}},
				{Type: field.ErrorTypeForbidden, Field: "spec.volumes[19].flocker", BadValue: []string{}},
				{Type: field.ErrorTypeForbidden, Field: "spec.volumes[20].fc", BadValue: []string{}},
				{Type: field.ErrorTypeForbidden, Field: "spec.volumes[21].azureFile", BadValue: []string{}},
				{Type: field.ErrorTypeForbidden, Field: "spec.volumes[22].vsphereVolume", BadValue: []string{}},
				{Type: field.ErrorTypeForbidden, Field: "spec.volumes[23].quobyte", BadValue: []string{}},
				{Type: field.ErrorTypeForbidden, Field: "spec.volumes[24].azureDisk", BadValue: []string{}},
				{Type: field.ErrorTypeForbidden, Field: "spec.volumes[25].photonPersistentDisk", BadValue: []string{}},
				{Type: field.ErrorTypeForbidden, Field: "spec.volumes[26].portworxVolume", BadValue: []string{}},
				{Type: field.ErrorTypeForbidden, Field: "spec.volumes[27].scaleIO", BadValue: []string{}},
				{Type: field.ErrorTypeForbidden, Field: "spec.volumes[28].storageos", BadValue: []string{}},
				{Type: field.ErrorTypeForbidden, Field: "spec.volumes[29].unknown", BadValue: []string{}},
			},
		},
	}
	...
	for _, tc := range tests {
		t.Run(tc.name, func(t *testing.T) {
			result := restrictedVolumes_1_0(&tc.pod.ObjectMeta, &tc.pod.Spec, tc.opts)
			if result.Allowed {
